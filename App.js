...
constructor(props) {
 ...
 InsertStudentRecordsToServer = () =>{
      ...
      fetch('https://mycleancity.000webhostapp.com/InsertStudentData.php', {
      method: 'POST',
      headers: {
...
class ShowStudentListActivity extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('https://mycleancity.000webhostapp.com/ShowAllStudentsList.php')
         .then((response) => response.json())
         .then((responseJson) => {
...
class EditStudentRecordActivity extends Component {
  ...
  constructor(props) {
    ...
    UpdateStudentRecord = () =>{
            ...
            fetch('https://mycleancity.000webhostapp.com/UpdateStudentRecord.php', {
            method: 'POST',
            headers: {
    ...
    DeleteStudentRecord = () =>{
          ...
          fetch('https://mycleancity.000webhostapp.com/DeleteStudentRecord.php', {
          method: 'POST',
          headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
...
const App = createAppContainer(MyNewProject);
